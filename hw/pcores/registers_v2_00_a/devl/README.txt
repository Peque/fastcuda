...
Peripheral Summary:
  ...
  XPS project / EDK repository               : /home/peque/xilinx/fcbuild_peque
  logical library name                       : registers_v1_00_a
  top name                                   : registers
  version                                    : 1.00.a
  type                                       : AXI4LITE slave
...
- XST synthesis file(s)
  ...
  devl/synthesis/registers_xst.prj
...
-user needs to add these to repositories path in SDK (Xilinx Tools-->Repositories)
  ...
  data/registers_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/registers_v2_1_0.tcl
...
axi_lite_ipif_v1_01_a
	/opt/Xilinx/14.1/ISE_DS/EDK/hw/XilinxProcessorIPLib/pcores/axi_lite_ipif_v1_01_a/doc/axi_lite_ipif_ds765.pdf
